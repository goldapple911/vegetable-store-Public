...
const CartItemCard = observer((props: any) => {
  const {
    cartItem
  } = props
    ...
    >
        ...
        >
          ...
          <div className={classes.holder}>
            <button
              ...
              onClick={() => cartStore.removeItemFromCart(item, 1)}
            >
              <img
            ...
            <button
              className={classes.paginator}
              onClick={() => cartStore.addItemToCart(item)}
            >
              <img
      ...
      >
        ...
        <button
          ...
          onClick={() => cartStore.removeItemFromCart(item, cartItem.count)}
        >
          <img
            src={require('../../images/icons/cross_white.svg')}
            alt=""
          />
        </button>
      </div>
