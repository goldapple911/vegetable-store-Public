...
export default () => (
  <main className={classes.CataloguePageContent}>
    <div className="container">
      ...
      <ul>
        <li>До пункта выдачи &ndash; бесплатно в течении 3х дней:</li>
        <ul>
          <li>Тургенева,15 кофейня «May be cup»;</li>
          <li>Студия йоги «Делай йогу», Ленина, 53;</li>
          <li>Пекарня «GoBakery”, Попова,2/Вайнера,12;</li>
        </ul>
